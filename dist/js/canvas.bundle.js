...
function animateDot(dot, canvas) {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(dot, {
...
addEventListener('load', function (e) {
  ...
  pixels.forEach(function (pixel, i) {
    var imageX = pixel.x + canvas.width / 2 - img.naturalWidth / 2;
    var imageY = pixel.y + canvas.height / 2 - img.naturalHeight / 2;
    var rand = Math.random() * Math.PI * 2;
    var x = Math.sin(rand) * radius + canvas.width / 2;
    var y = Math.cos(rand) * radius + canvas.height / 2;
    dots.push(new _Dot__WEBPACK_IMPORTED_MODULE_1__["default"](x, y, pixel.r, pixel.g, pixel.b, imageX, imageY));
